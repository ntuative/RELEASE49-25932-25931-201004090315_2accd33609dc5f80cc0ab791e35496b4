package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1557:String = "_INCLUDE";
      
      public static const const_942:String = "_EXCLUDE";
      
      public static const const_1447:String = "_TEMP";
      
      private static const const_1095:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1096:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_947:Dictionary;
      
      protected var var_1390:Map;
      
      protected var var_14:IWindowContext;
      
      protected var var_1391:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         super();
         var_14 = param1;
         var_1114 = new Dictionary();
         var_1113 = new Dictionary();
         TypeCodeTable.fillTables(var_1114,var_1113);
         var_947 = new Dictionary();
         var_1391 = new Dictionary();
         ParamCodeTable.fillTables(var_947,var_1391);
         var_1390 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1096,"");
         return param1.replace(const_1095,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1114)
            {
               delete var_1114[_loc1_];
            }
            for(_loc1_ in var_1113)
            {
               delete var_1113[_loc1_];
            }
            for(_loc1_ in var_947)
            {
               delete var_947[_loc1_];
            }
            for(_loc1_ in var_1391)
            {
               delete var_1391[_loc1_];
            }
            var_1390.dispose();
            var_1390 = null;
            var_14 = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "AvatarImagePartContainer";
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "AvatarImagePartContainer";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "AvatarImagePartContainer";
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_942) == -1)
                  {
