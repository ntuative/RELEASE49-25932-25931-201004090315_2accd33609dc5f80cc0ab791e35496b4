package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_773:uint = 8;
       
      
      private var var_2105:Dictionary;
      
      private var var_1546:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1546 = new Dictionary();
         var_2106 = new Dictionary();
         TypeCodeTable.fillTables(var_1546,var_2106);
         var_1293 = new Dictionary();
         var_2105 = new Dictionary();
         StateCodeTable.fillTables(var_1293,var_2105);
         var_517 = new Dictionary();
         var_517["skin"] = BitmapSkinRenderer;
         var_517["bitmap"] = BitmapDataRenderer;
         var_517["fill"] = FillSkinRenderer;
         var_517["text"] = TextSkinRenderer;
         var_517["shape"] = ShapeSkinRenderer;
         var_517["unknown"] = SkinRenderer;
         var_517["HabboHelpCom_help_cfh_pick_topic_xml"] = NullSkinRenderer;
         if(var_379 == null)
         {
            var_379 = new Array();
            var_379.push(WindowState.const_61);
            var_379.push(WindowState.const_68);
            var_379.push(WindowState.const_92);
            var_379.push(WindowState.WINDOW_STATE_SELECTED);
            var_379.push(WindowState.const_79);
            var_379.push(WindowState.const_73);
            var_379.push(WindowState.const_94);
            var_379.push(WindowState.const_86);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1293)
         {
            _loc3_.push(var_1293[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  _loc20_.background = !!_loc7_.@background[0] ? _loc7_.@background[0] == "AvatarImagePartContainer" : false;
                  ...
                  addSkinRenderer(var_1546[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_735[param1] = new Array(SkinContainer.const_773);
         }
         var_735[param1][param2] = param3;
         if(true)
         {
            var_736[param1] = new Array(SkinContainer.const_773);
         }
