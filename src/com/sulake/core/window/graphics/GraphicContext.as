package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_839:uint = 256;
      
      protected static var var_643:uint = 0;
      
      protected static var var_378:uint = 0;
      
      public static const const_860:uint = 2;
      
      public static const const_1453:uint = 128;
      
      public static const const_1511:uint = 64;
      
      public static const const_627:uint = 4;
      
      public static const const_1355:uint = 0;
      
      public static const const_1275:uint = 16;
      
      public static const const_687:uint = 1;
      
      public static const const_1262:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_637:Boolean;
      
      protected var var_1608:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_860:
               ...
               break;
            case GraphicContext.const_1262:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1275:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_627:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_839:
               break;
            case GraphicContext.const_1355:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_637)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_378 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_637)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_378 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1608,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1608,16777215);
                  }
                  var_378 += bitmap.width * bitmap.height * 4;
               }
