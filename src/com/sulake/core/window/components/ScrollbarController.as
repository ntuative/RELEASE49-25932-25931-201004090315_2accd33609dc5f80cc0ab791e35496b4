package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1033:String = "increment";
      
      private static const const_482:String = "slider_bar";
      
      private static const const_1034:String = "decrement";
      
      private static const const_746:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_159 = false;
         var_19 = param12;
         _horizontal = param2 == WindowType.const_462;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_482:
      ...
      {
         return findChildByName(ScrollbarController.const_746) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_19 != null && true)
         {
            IWindow(var_19).removeEventListener(WindowEvent.const_45,onScrollableResized);
         }
         var_19 = param1;
         if(var_19 != null && true)
         {
            IWindow(var_19).addEventListener(WindowEvent.const_45,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_482) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_776 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_776 != null)
         {
            _loc1_ = findParentByName(var_776) as IScrollableWindow;
            if(_loc1_ == null && var_8 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_776) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1033)
            {
               if(var_19)
               {
                  var_552 = true;
            ...
            else if(param2.name == ScrollbarController.const_1034)
            {
               if(var_19)
               {
                  var_552 = true;
            ...
            else if(param2.name == ScrollbarController.const_746)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_482).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_1014)
         {
