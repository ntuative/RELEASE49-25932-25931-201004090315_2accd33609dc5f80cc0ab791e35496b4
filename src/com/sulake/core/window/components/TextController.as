package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2351:Rectangle = new Rectangle();
      ...
      protected var var_541:String = "none";
      
      protected var var_634:Number;
      
      protected var var_372:Number;
      
      protected var _field:TextField;
      
      protected var var_770:Boolean = false;
      ...
      {
         return new Rectangle(var_634 * maxScrollH,var_372 * maxScrollV,width,height);
      }
      ...
      {
         var_634 = param1;
         _field.scrollH = var_634 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_207)
         {
            if(param2.type == WindowNotifyEvent.const_166)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_815,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_453,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_453,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_730,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_730,true));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_541,PropertyStruct.STRING,var_541 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_730,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_634 = var_634;
         _loc1_.var_372 = var_372;
         _loc1_.var_65 = var_65.clone(_loc1_.setTextMargins);
         _loc1_.var_541 = var_541;
         _loc1_.var_770 = var_770;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_541 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_541 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_541 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_541 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
