package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1133:String = "content";
      
      private static const const_1132:String = "selector";
       
      
      private var var_1166:Boolean = false;
      
      protected var var_951:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1612 == null)
         {
            var_1612 = findChildByTag(TabContextController.const_1133) as IWindowContainer;
         }
         return var_1612;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_951 == null)
         {
            var_951 = findChildByTag(TabContextController.const_1132) as ITabSelectorWindow;
            if(var_951 != null)
            {
               var_951.procedure = selectorEventProc;
            }
         }
         return var_951;
      }
      ...
      {
         return !!var_826 ? selector.iterator : null;
      }
