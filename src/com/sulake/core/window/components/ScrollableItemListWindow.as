package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_889:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_360)
         {
            ...
            if(var_360)
            {
               var_360.addEventListener(WindowEvent.const_245,scrollBarEventProc);
               var_360.addEventListener(WindowEvent.const_215,scrollBarEventProc);
            }
         }
         return var_360;
      }
      ...
      override public function dispose() : void
      {
         if(var_360)
         {
            var_360.removeEventListener(WindowEvent.const_245,scrollBarEventProc);
            var_360.removeEventListener(WindowEvent.const_215,scrollBarEventProc);
            var_360 = null;
         }
         if(var_889)
         {
      ...
      {
         if(param1.type == WindowEvent.const_245)
         {
            showScrollBar();
         }
         else if(param1.type == WindowEvent.const_215)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_889)
         {
            var_889 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_889;
      }
