package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      {
         var _loc2_:Object = var_120[param1];
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_120)
         {
            delete var_120[_loc1_];
         }
         _length = 0;
         var_27 = [];
         var_212 = [];
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         var_120[param1] = param2;
         var _loc3_:int = var_212.indexOf(param1);
         if(_loc3_ == -1)
         {
            var_27[_length] = param2;
            var_212[_length] = param1;
            ++_length;
         }
         else
         {
