package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1181:Map = new Map();
      
      private static var var_805:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         var _loc1_:String = "";
         var _loc2_:int = 0;
         while(_loc2_ < var_805.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_805.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_805.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_805.remove(param1);
         var_805.add(param1,param2);
      }
      
      public static function setParameter(param1:String, param2:String) : void
      {
         var_1181[param1] = param2;
      }
   }
}
