package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1230:int = 10000;
      ...
      private var var_673:IEncryption;
      ...
      private var var_341:IConnectionStateListener;
      
      private var var_572:IProtocol;
      
      private var var_802:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         var_802 = new MessageClassManager();
         var_74 = new Socket();
         var_340 = new Timer(const_1230,1);
         var_340.addEventListener(TimerEvent.TIMER,onTimeOutTimer);
      ...
      {
         var_340.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_672));
      ...
      {
         var_340.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_672));
      ...
      private function onConnect(param1:Event) : void
      {
         var_340.stop();
         var_1179 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_672));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_802.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         var _loc5_:ByteArray = var_572.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_341)
         {
            var_341.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_673 != null)
         {
            _loc3_ = var_673.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_341)
         {
            var_341.connectionInit(param1,param2);
         }
      ...
      {
         var_802.registerMessages(param1);
      }
      ...
      {
         var_340.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_672));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_572.getMessages(var_339,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_341)
            {
               var_341.messageReceived(String(_loc5_),_loc6_.toString());
            }
            _loc7_ = var_802.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
      ...
      {
         var_340.delay = param1;
      }
      
      private function onIOError(param1:IOErrorEvent) : void
      {
         var_340.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_672));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         var_340.stop();
         var_1179 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_672));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_673 + "\n");
      }
   }
}
