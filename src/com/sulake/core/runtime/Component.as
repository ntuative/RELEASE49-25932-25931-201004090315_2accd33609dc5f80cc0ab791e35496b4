package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_904:uint = 4;
      ...
      protected var var_401:uint = 0;
      
      protected var var_14:IContext = null;
      
      protected var var_1673:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_945 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_945);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1104 & const_904)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_401 + "]";
      }
   }
}
