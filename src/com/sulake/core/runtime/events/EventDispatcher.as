package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_481:uint = 0;
      
      private static const const_745:uint = 2;
       
      
      private var var_644:Error;
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_745)
            {
               if(var_644 != null)
               {
                  Core.crash("Error catched in EventDispatcher: undefined",var_644.errorID,var_644);
               }
               else
               {
                  Core.crash("Error catched in EventDispatcher. No error data available!",0,var_644);
               }
            }
            return _result == const_481;
         }
         return false;
      }
      ...
      public function removeEventListener(param1:String, param2:Function, param3:Boolean = false) : void
      {
         ...
         if(!_disposed)
         {
            ...
            if(_loc4_)
            {
               ...
               {
                  if(_loc6_.callback == param2 && _loc6_.var_2269 == param3)
                  {
      ...
      public function addEventListener(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         else
         {
            ...
            {
               if(_loc8_.callback == param2 && _loc8_.var_2269 == param3)
               {
                  return;
               }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1032) : uint(const_481);
      }
