package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         var _loc3_:BitmapDataCacheItem = var_344.getValue(param1) as BitmapDataCacheItem;
         if(_loc3_ != null)
         {
      ...
      public function compress() : void
      {
         ...
         {
            var_343.sortOn("useCount",0 | 0);
            _loc2_ = -1;
            while(_loc2_ >= 0)
            {
               _loc1_ = var_343[_loc2_] as BitmapDataCacheItem;
            ...
            var_343.splice(_loc2_,0 - _loc2_);
            if(memUsage > memLimit)
            {
               var_343.sortOn("memUsage",Array.NUMERIC);
               while(memUsage > memLimit)
               {
                  _loc1_ = var_343.pop() as BitmapDataCacheItem;
                  if(_loc1_ == null)
                  {
                     break;
                  }
      ...
      {
         var _loc2_:BitmapDataCacheItem = var_344.getValue(param1) as BitmapDataCacheItem;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      private function removeItem(param1:BitmapDataCacheItem) : void
      {
         ...
         param1 = var_344.remove(param1.name) as BitmapDataCacheItem;
         if(param1 != null)
         {
            var_483 -= param1.memUsage;
            param1.dispose();
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_344 != null)
         {
            ...
            {
               _loc2_ = var_344.getWithIndex(_loc1_) as BitmapDataCacheItem;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
