package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_712:int = -1;
      ...
      private var var_2383:IRoomContentLoader;
      
      private var var_41:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         _events.addEventListener(RoomContentLoadedEvent.const_438,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_707,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_30 == const_1228)
         {
            if(var_831 != null)
            {
               return false;
         ...
         var_1455 = 50;
         var_109 = param2;
         var _loc3_:Array = var_41.getPlaceHolderTypes();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            ...
            {
               var_41.loadObjectContent(_loc5_,_events);
               var_494.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      {
         if(var_30 < ROOM_MANAGER_INITIALIZED)
         {
         ...
         if(!var_41.hasInternalContent(param3))
         {
            _loc7_ = var_41.getGraphicAssetCollection(param3);
            if(_loc7_ == null)
            {
               var_41.loadObjectContent(param3,_events);
               _loc12_ = var_41.getPlaceHolderType(param3);
               _loc7_ = var_41.getGraphicAssetCollection(_loc12_);
            }
            _loc8_ = var_41.getVisualizationXML(_loc12_);
            _loc9_ = var_41.getLogicXML(_loc12_);
            if(_loc8_ == null || _loc7_ == null)
            {
               return null;
            }
            _loc10_ = var_41.getVisualizationType(_loc12_);
            _loc11_ = var_41.getLogicType(_loc12_);
         }
         else
         {
            _loc10_ = param3;
      ...
      public function isContentAvailable(param1:String) : Boolean
      {
         if(var_41 != null)
         {
            if(var_41.getGraphicAssetCollection(param1) != null)
            {
               return true;
            }
         }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         var _loc3_:XML = var_41.getVisualizationXML(_loc2_);
         if(_loc3_ == null)
         {
            if(var_109 != null)
            {
         ...
         var _loc4_:IGraphicAssetCollection = var_41.getGraphicAssetCollection(_loc2_);
         if(_loc4_ == null)
         {
            if(var_109 != null)
            {
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_41.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(false)
            {
               var_30 = ROOM_MANAGER_INITIALIZED;
               if(var_109 != null)
               {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(var_41 == null || var_417 == null)
         {
            return;
         }
         var _loc2_:XML = var_41.getVisualizationXML(param1);
         var _loc3_:XML = var_41.getLogicXML(param1);
         var _loc4_:IGraphicAssetCollection = var_41.getGraphicAssetCollection(param1);
               ...
               while(_loc10_ >= 0)
               {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        _loc16_ = var_41.getContentType(_loc15_);
                        if(_loc16_ == param1)
                        {
                           _loc17_ = var_41.getVisualizationType(_loc15_);
                           _loc18_ = var_41.getLogicType(_loc15_);
