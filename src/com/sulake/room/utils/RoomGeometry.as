package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_941:Number = 32;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_81 = new Vector3d();
         var_984 = new Vector3d();
         var_1431 = 1;
         var_1432 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1430 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_391 != param1 * var_1430)
         {
            var_391 = param1 * var_1430;
            ++var_73;
         }
      }
      ...
      {
         if(var_392 != param1 * var_1431)
         {
            var_392 = param1 * var_1431;
            ++var_73;
         }
      }
      ...
      {
         if(var_389 != param1 * var_1432)
         {
            var_389 = param1 * var_1432;
            ++var_73;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_984.assign(_loc22_);
         }
         else
         {
            var_984.assign(_loc17_);
         }
         ++var_73;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,var_67);
         _loc2_.x *= var_392;
         _loc2_.y *= var_389;
         _loc2_.z *= var_391;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_984);
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,var_67);
            _loc2_.add(_loc6_);
            _loc2_.x *= var_392;
            _loc2_.y *= var_389;
            _loc2_.z *= var_391;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_984);
         }
      ...
      {
         return new Vector3d(0 * var_392,0 * var_389,0 * var_391);
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var_67.y = 0 / var_389;
         var_67.z = 0 / var_391;
         if(var_67.x != _loc2_ || var_67.y != _loc3_ || var_67.z != _loc4_)
         {
            ++var_73;
         }
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_392,0 * var_389,0 * var_391);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_81;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_392,param2.y * var_389,param2.z * var_391);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_392,param3.y * var_389,param3.z * var_391);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_392,param4.y * var_389,param4.z * var_391);
