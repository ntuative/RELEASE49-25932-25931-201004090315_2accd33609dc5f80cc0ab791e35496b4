package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_372:IScrollbarWindow;
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1264 != null)
         {
            _loc2_ = var_1264.tags[0];
            var_1264.color = getBgColor(_loc2_);
         }
         var_1264 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_372 = IScrollbarWindow(var_18.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_2044 - _loc2_.stageX);
         var_2044 = _loc2_.stageX;
         var_2043 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         var_856.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1338,true);
