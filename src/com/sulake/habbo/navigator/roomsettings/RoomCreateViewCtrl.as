package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1340:Boolean = true;
      
      private var var_913:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_528 = new Timer(100);
         var_528.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_37 = new Array();
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,104,"a"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,94,"b"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,36,"c"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,84,"d"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"e"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"f"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,416,"i"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,320,"j"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,448,"k"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,352,"l"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,384,"m"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_49,372,"n"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_58,80,"g"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_58,74,"h"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_58,416,"o"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_58,352,"p"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_58,304,"q"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_58,336,"r"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_58,748,"u"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_58,438,"v"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,540,"t"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,512,"w"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,396,"x"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,440,"y"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,456,"z"));
         var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_47 = IItemListWindow(var_18.findChildByName("item_list"));
         ...
         var_1076 = new TextFieldManager(_navigator,ITextFieldWindow(var_18.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_528)
         {
            var_528.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_528.reset();
            var_528 = null;
         }
      }
      ...
      {
         var_1076.goBackToInitialState();
         var_1076.input.textBackgroundColor = 4294967295;
         var_913 = var_37[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_59,HabboWindowStyle.const_39,HabboWindowParam.const_71,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1076.getText();
      ...
      {
         var _loc1_:Boolean = var_1076.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      private function refreshSelection() : void
      {
         ...
         var _loc2_:* = false;
         var _loc3_:* = null;
         for each(_loc1_ in var_37)
         {
            if(_loc1_.view != null)
            {
               _loc2_ = _loc1_ == var_913;
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_913.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1340 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1340 = true;
            _loc3_.y = 1;
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         while(false)
         {
            _loc6_ = var_47.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in var_37)
         {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < var_37.length)
         {
            _loc7_ = var_37[_loc4_];
            if(isAllowed(_loc7_))
            {
               if(_loc2_ == 0)
               {
               ...
               addThumbnail(_loc3_,var_37[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
