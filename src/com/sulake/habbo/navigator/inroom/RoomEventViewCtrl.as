package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2100:IButtonWindow;
      ...
      private var var_2099:ITextWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         addTag(_loc6_,var_884.getText());
         addTag(_loc6_,var_885.getText());
      ...
      {
         var_883.visible = false;
         var_1544.visible = true;
         var_2099.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_733.setText(param1.eventDescription);
         var_884.setText(getTagFromEvent(param1,1));
         var_885.setText(getTagFromEvent(param1,2));
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1544 = IWindowContainer(find("event_type_disabled_cont"));
            var_2099 = ITextWindow(find("event_type_disabled_text"));
            var_1542 = ITextWindow(find("create_caption"));
            var_1543 = ITextWindow(find("edit_caption"));
            var_1290 = IButtonWindow(find("create_button"));
            var_1291 = IButtonWindow(find("edit_button"));
            var_2100 = IButtonWindow(find("cancel_button"));
            var_1292 = IButtonWindow(find("end_button"));
            var_883 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1290,onCreateButtonClick);
            Util.setProcDirectly(var_1291,onEditButtonClick);
            Util.setProcDirectly(var_1292,onEndButtonClick);
            Util.setProcDirectly(var_2100,onCancelButtonClick);
            ...
            var_884 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_885 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      {
         var_883.visible = true;
         var_1544.visible = false;
         ...
         var_884.goBackToInitialState();
         var_885.goBackToInitialState();
         var_883.selection = 0;
