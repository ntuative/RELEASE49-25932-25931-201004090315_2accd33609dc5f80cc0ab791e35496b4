package com.sulake.habbo.session.handler
{
   ...
   public class RoomUsersHandler extends BaseHandler
   {
      ...
      private function onDoorbell(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:IRoomSession = listener.getSession(_xxxRoomId,var_32);
         if(_loc3_ == null)
         {
            return;
         }
         listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_105,_loc3_,_loc2_.userName));
      }
      ...
      private function onPetPlacingError(param1:PetPlacingErrorEvent) : void
      {
         ...
         var _loc2_:IRoomSession = listener.getSession(_xxxRoomId,var_32);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function onUserNameChange(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:IRoomSession = listener.getSession(_xxxRoomId,var_32);
         if(_loc4_ == null)
         {
            return;
         }
