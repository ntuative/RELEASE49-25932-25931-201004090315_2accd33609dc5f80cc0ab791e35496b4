package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_30:String = "RSE_CREATED";
      
      private var var_1073:UserDataManager;
      ...
      {
         if(var_30 == RoomSessionEvent.const_331 && _connection != null)
         {
            var_30 = RoomSessionEvent.const_93;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1073 as IUserDataManager;
      }
