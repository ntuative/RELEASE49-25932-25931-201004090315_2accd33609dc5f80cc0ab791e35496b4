package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_666:ISkinContainer;
      
      private var var_220:Array;
      
      private var var_2370:Array;
      ...
      private var var_1176:ProfilerAgentTask;
      
      private var var_1175:IEventDispatcher;
      
      private var var_2371:uint = 0;
      
      private var var_1174:ProfilerAgentTask;
      
      private var var_1177:ProfilerOutput;
      
      private var var_671:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1175 = Component(param1).events;
         var_396 = new Array();
      ...
      {
         return var_220[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_220[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_666 = new SkinContainer(_loc3_.content as XML,assets);
         var_671 = new WindowRenderer(var_666);
         var_220 = new Array(const_343);
         var _loc5_:int = 0;
         while(_loc5_ < const_343)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_671,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_220[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_220[const_1052];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_318,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1227,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_220[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_220.pop()).dispose();
            }
            var_220 = null;
            while(false)
            {
      ...
      {
         return var_220[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1177 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1177 = new ProfilerOutput(_loc3_,this,var_671);
               var_1176 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1176);
               var_1174 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1174);
               var_987 = true;
            }
         }
      }
      ...
      {
         return var_666.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_939.length > 0)
         {
            var_1175.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_343 - 1;
            while(_loc2_ >= 0)
            {
               var_220[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_987)
         ...
         var_1175.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_343)
         {
            var_220[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_987)
         {
         ...
         if(WindowContext.var_939.length > 0)
         {
            WindowContext.var_939.flush();
         }
         if(WindowContext.var_1376.length > 0)
         {
            WindowContext.var_1376.flush();
         }
         var_1175.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1138,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1255,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1281,param2.name + ": " + param2.toString());
            }
         }
      }
   }
