package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private var var_422:IConversationsDeps;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_666,0,var_422.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Conversation = method_4(param1);
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         ...
         _loc2_ = var_422.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_422.getTabCount());
      ...
      {
         return var_422.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function method_4(param1:int) : Conversation
      {
         var _loc2_:* = null;
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         while(_startIndex + var_422.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var_422.addMsgToView(_loc3_,_loc4_);
      }
      ...
      {
         return new Message(Message.const_497,0,getOnlineText(param1),Util.getFormattedNow());
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_422.addMsgToView(_loc3_,param1);
