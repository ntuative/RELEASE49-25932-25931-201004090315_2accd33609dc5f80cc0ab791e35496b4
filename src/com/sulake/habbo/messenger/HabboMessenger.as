package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_294:MessengerView;
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1023,_loc2_.senderId,getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function startConversation(param1:int) : void
      {
         var _loc2_:Conversation = var_583.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_583.setSelected(_loc2_);
            var_294.openMessenger();
            var_294.refresh(true);
         }
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = var_154.getKey("url.prefix",_loc2_);
      ...
      {
         var_583.addMessageAndUpdateView(param1);
         if(!var_294.isMessengerOpen())
         {
      ...
      {
         var_583 = new Conversations(new ConversationsDeps(this));
         var_294 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.MESSENGER));
      ...
      {
         var_583.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         var_583.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var_583.addMessageAndUpdateView(_loc3_);
      }
