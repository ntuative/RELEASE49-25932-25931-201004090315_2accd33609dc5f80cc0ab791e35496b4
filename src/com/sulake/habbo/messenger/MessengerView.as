package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1145:ConversationView;
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_724.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_724.text = "";
         var_124.conversations.addMessageAndUpdateView(new Message(Message.const_607,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      public function openMessenger() : void
      {
         ...
         if(var_13 == null)
         {
            prepareContent();
            refresh(true);
            var_124.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MESSENGER,var_13));
         }
         else
         {
            refresh(true);
      ...
      {
         var_13 = IFrameWindow(var_124.getXmlWindow("main_window"));
         ...
         var_787 = new ConversationsTabView(var_124,var_13);
         var_787.refresh();
         var_724 = ITextFieldWindow(var_13.findChildByName("message_input"));
         var_724.addEventListener(WindowKeyboardEvent.const_145,onMessageInput);
         var_1145 = new ConversationView(var_124,var_13);
         var_13.scaler.setParamFlag(HabboWindowParam.const_655,false);
         var_13.scaler.setParamFlag(HabboWindowParam.const_932,true);
      }
   }
}
