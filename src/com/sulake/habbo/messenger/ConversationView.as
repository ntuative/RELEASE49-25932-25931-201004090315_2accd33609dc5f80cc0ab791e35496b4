package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1115:int = 20;
      
      private static const const_782:int = 100;
       
      
      private var var_2175:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_124 = param1;
         var_1569 = initButton("follow_friend",onFollowButtonClick,param2);
         var_47 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2175 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      {
         if(param1 == Message.const_666)
         {
            return 4285887861;
         }
         if(param1 == Message.const_497)
         {
            return 4285887861;
         }
         return 4278190080;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_607 || param3.type == Message.const_590 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_523.messages.length - const_782);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_523.messages.length)
         {
            refreshEntry(true,_loc1_,var_523.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_523 == null || _loc1_.id != var_523.id)
         {
            var_523 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_782 + const_1115)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_124.send(new FollowFriendMessageComposer(var_523.id));
      }
