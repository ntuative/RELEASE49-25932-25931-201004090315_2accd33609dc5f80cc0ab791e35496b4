package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_489:int = 16;
      ...
      private var var_435:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1021 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1918 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1919 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_696 = new Timer(1000,1);
         var_696.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_830 = new Timer(5000,1);
         var_830.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_59,HabboWindowStyle.const_40,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_145,windowKeyEventProcessor);
         ...
         _window.addEventListener(WindowEvent.const_381,onWindowMoved);
         var_1224 = true;
         var_128 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1917 = _loc2_.width + const_489 + _loc6_.width + const_1078;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1077,_loc8_.width) + const_489);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1021 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_128 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_435);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_435);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_491);
