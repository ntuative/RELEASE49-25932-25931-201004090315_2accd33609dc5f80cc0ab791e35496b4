package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_489:int = 6;
      
      private static const const_344:int = 10;
      
      private static const const_1057:Number = 18;
      
      private static const const_1416:Number = 10;
      ...
      {
         _widget.onItemMouseOut(var_1000,var_998,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1000,var_680,var_998,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1193 = param1.chatType;
         var_1000 = param1.userId;
         var_680 = param1.userName;
         var_998 = param1.userCategory;
         _message = param1.text;
         var_1192 = param1.userX;
         var_187 = param1.userImage;
         var_999 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_82,_y,width,_height);
      ...
      public function renderView() : void
      {
         ...
         var_93 = _window as IRegionWindow;
         var_93.background = true;
         var_93.mouseTreshold = 0;
         enableTooltip();
         addEventListenerToChild(var_93);
         ...
         if(var_187 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_399 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_999 != 0)
            {
               _loc30_ = uint(var_999 >> 16 & 255);
               _loc31_ = uint(var_999 >> 8 & 255);
               _loc32_ = uint(var_999 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_344;
            }
            else
            {
               _loc19_.text = var_680 + ":";
               _loc19_.y += var_399;
               _loc19_.width = _loc19_.textWidth + const_344;
               _width += _loc19_.textWidth + const_344;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1193 == RoomWidgetChatUpdateEvent.const_255)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_680);
            }
            else if(var_1193 == RoomWidgetChatUpdateEvent.const_239)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_680);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_399;
            _loc20_.width = _loc20_.textWidth + const_489;
            _width += _loc20_.textWidth + const_489;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_344 + _loc20_.textWidth + const_489;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1000,var_998,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1000,var_998,_roomId,_roomCategory,param1);
      }
