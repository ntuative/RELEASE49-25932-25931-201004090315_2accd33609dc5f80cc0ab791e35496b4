package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1109:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_155.state = RoomChatHistoryPulldown.const_221;
         ...
         var_40 = param2.createWindow("chatscroller","",HabboWindowType.const_903,HabboWindowStyle.const_40,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_237 > 0 && param2)
         {
            if(var_1331)
            {
               if(Math.abs(param1 - var_237) <= const_867)
               {
                  return;
               }
               var_1331 = false;
            ...
            if(var_311)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_40.scrollV < 1 - const_1109 / var_40.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1567)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_311 && !var_1219)
         {
            ...
            var_155.state = RoomChatHistoryPulldown.const_330;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_155.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_221);
      }
