package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_250:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_624:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1302:String = "POLL_OFFER_STATE_OK";
      ...
      private var var_30:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_30 = const_1302;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_580,_id));
                     break;
