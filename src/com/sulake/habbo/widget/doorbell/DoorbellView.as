package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var_49 = (_doorbell.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_49 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         var_47 = var_49.findChildByName("user_list") as IItemListWindow;
         var_49.visible = false;
         var _loc2_:IWindow = var_49.findChildByTag("close");
         if(_loc2_ != null)
         {
