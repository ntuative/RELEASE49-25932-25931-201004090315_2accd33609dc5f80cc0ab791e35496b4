      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_883);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_863));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_539);
               break;
            case "rooms":
            ...
            case "badges":
               ...
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_336);
               break;
            case "hc":
               ...
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_695);
               break;
            case "news":
               if(false && false)
               {
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","false") == "AvatarImagePartContainer";
               if(false && _loc4_)
               {
