package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      {
         super();
         var_161 = new Timer(1000);
         var_161.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_853 = _window.findChildByName("effect_hilite");
            var_853.visible = false;
         }
         var_855 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_854 = _window.findChildByName("loader_bar");
         if(var_854 != null)
         {
            var_435 = var_854.width;
            var_161.start();
            onUpdate();
         }
         if(false)
      ...
      public function dispose() : void
      {
         ...
         {
            var_161.stop();
            var_161.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_161 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_855 != null)
         {
            var_855.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_855.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
