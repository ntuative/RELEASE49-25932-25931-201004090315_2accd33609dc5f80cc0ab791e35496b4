package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1657:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1655:String = "level";
      
      private var var_98:IItemListWindow;
      
      private const const_1653:String = "energy";
      
      private var var_1316:Map;
      
      private const const_1659:String = "nutrition";
      
      private var var_59:IItemListWindow;
      
      private const const_1652:uint = 3355443;
      
      private var var_223:IBorderWindow;
      
      private const const_1654:int = 158;
      
      private const const_1658:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_177:PetCommandTool;
      
      private const const_1660:uint = 11184810;
      
      private const const_1656:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_223 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_223 != null)
         {
            var_98 = var_223.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_223.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_223.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_98.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_98.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(var_98 == null || var_223 == null || var_59 == null)
         {
            return;
         }
         var_59.width = var_59.scrollableRegion.width;
         var_59.visible = false;
         var_98.height = var_98.scrollableRegion.height;
         var_223.height = NaN;
         _window.width = Math.max(var_223.width,var_59.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1316.getValue(var_567) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function set name(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_98.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_98.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_98.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1655,param1.level,param1.levelMax);
         updateStateElement(const_1656,param1.experience,param1.experienceMax);
         updateStateElement(const_1653,param1.energy,param1.energyMax);
         updateStateElement(const_1659,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_567 = param1.id;
         var_1316.remove(param1.id);
         var_1316.add(param1.id,param1);
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_98.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_177 && var_177.getPetId() == var_567)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_430,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1654,const_1658,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1660);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1652);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1657);
         return _loc5_;
      }
