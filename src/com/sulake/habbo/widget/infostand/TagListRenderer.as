package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1632:int = 5;
      
      private const const_1633:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1137 != null && var_1137.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_778 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_778 += param1.height + const_1633;
            return fit(param1);
         }
         param1.offset(_offsetX,var_778);
         _offsetX += param1.width + const_1632;
         return true;
      }
