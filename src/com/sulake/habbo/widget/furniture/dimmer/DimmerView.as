package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_59,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1042,const_1041,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(var_335 != null)
         {
            var_335.setValue(var_978);
         }
         var_428 = colors.indexOf(_loc2_.color);
         if(var_468 != null)
         {
            var_468.setSelectedColorIndex(var_428);
         }
