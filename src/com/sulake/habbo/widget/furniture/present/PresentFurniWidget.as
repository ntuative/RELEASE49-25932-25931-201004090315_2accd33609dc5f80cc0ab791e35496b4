package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_389,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_433,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_369,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_356,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_389,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_433,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_369,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_356,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_66:
               ...
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_433:
               if(!var_231)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_369:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_356:
               if(!var_231)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_389:
               if(!var_231)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_728,var_153);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_59,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1042,const_1041,2,2),null,0) as IWindowContainer;
