package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_994:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_132 = new Map();
         var_851 = new Map();
         var_602 = new IssueBrowser(this,var_57.windowManager,var_57.assets);
         var_717 = [];
         var_852 = [];
         var_1043 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1043.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_132)
         {
            switch(param1)
            {
               case const_940:
                  ...
                  break;
               case const_671:
                  if(_loc4_.state == IssueMessageData.const_456 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_717 = var_717.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1217)
         {
            var_150.remove(param1.issueId);
            return;
         }
         ...
         if(var_717.indexOf(param1.issueId) != -1)
         {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1043.remove(param1);
         var_1043.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_456 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_1043.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_602 == null || !var_602.isOpen())
         {
            var_57.soundManager.playSound(HabboSoundTypesEnum.const_996);
         }
      }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_456 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
