package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1644:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1643:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1490:IIssueBrowserView;
      
      private const const_1663:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1642:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_226:ITabContextWindow;
      
      private var var_1492:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_353.view.width = var_226.container.width;
         var_353.view.height = var_226.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1642:
               if(var_1490 == null)
               {
                  var_1490 = new MyIssuesView(issueManager,this,var_226.container);
               }
               return var_1490;
            case const_1644:
               if(var_1491 == null)
               {
                  var_1491 = new OpenIssuesView(issueManager,this,var_226.container);
               }
               return var_1491;
            case const_1643:
               if(var_1492 == null)
               {
                  var_1492 = new PickedIssuesView(issueManager,this,var_226.container);
               }
               return var_1492;
            default:
               return null;
