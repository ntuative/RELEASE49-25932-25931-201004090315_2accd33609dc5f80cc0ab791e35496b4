package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_972:ICheckBoxWindow;
      ...
      private var var_973:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_579,_data.flatId),var_49,false,false,true);
      }
      ...
      private function setSendButtonState(param1:String) : void
      {
         ...
         var _loc3_:IButtonWindow = IButtonWindow(var_49.findChildByName(param1));
      ...
      {
         var _loc3_:ITextWindow = ITextWindow(var_49.findChildByName(param1));
         _loc3_.text = param2;
      }
      
      public function onRoomInfo(param1:RoomModerationData) : void
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_380);
         if(param1.flatId != var_380)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_380);
            return;
         }
         _data = param1;
         populate();
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new UserInfoFrameCtrl(_main,_data.ownerId),var_49,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1341,_loc2_,var_436.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_972.isSelected,var_973.isSelected,var_647.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1194);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1344);
      }
      
      public function populate() : void
      {
         var_47 = IItemListWindow(var_49.findChildByName("list_cont"));
         ...
         var_647 = ICheckBoxWindow(var_49.findChildByName("kick_check"));
         var_972 = ICheckBoxWindow(var_49.findChildByName("lock_check"));
         var_973 = ICheckBoxWindow(var_49.findChildByName("changename_check"));
         ...
         var_49.findChildByName("enter_room_but").procedure = onEnterRoom;
         var_49.findChildByName("chatlog_but").procedure = onChatlog;
         var_49.findChildByName("edit_in_hk_but").procedure = onEditInHk;
         var_49.findChildByName("bobba_filter_but").procedure = onBobbaFilter;
         var_49.findChildByName("send_caution_but").procedure = onSendCaution;
         var_49.findChildByName("send_message_but").procedure = onSendMessage;
         _main.disableButton(_main.initMsg.bobbaFilterPermission,var_49,"bobba_filter_but");
         _main.disableButton(_main.initMsg.chatlogsPermission,var_49,"chatlog_but");
         if(!_main.initMsg.roomKickPermission)
         {
            var_647.disable();
         }
         var_49.findChildByName("owner_name_txt").procedure = onOwnerName;
         this.onRoomChange();
      }
      ...
      {
         var_49 = IFrameWindow(_main.getXmlWindow("roomtool_frame"));
         _main.messageHandler.addRoomInfoListener(this);
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_380));
         Logger.log("BEGINNING TO SHOW: " + var_380);
      }
   }
}
