package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         var_49.caption = "Room visits: " + param1.userName;
         populate();
         onResizeTimer(null);
         var_49.visible = true;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2184.clone());
         ...
         new OpenRoomTool(var_49,_main,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_2184 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_49 = IFrameWindow(_main.getXmlWindow("roomvisits_frame"));
         var_47 = IItemListWindow(var_49.findChildByName("visits_list"));
