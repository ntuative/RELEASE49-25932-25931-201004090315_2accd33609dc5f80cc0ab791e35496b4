package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1433:uint = 4.294967295E9;
      
      private const const_1434:uint = 4.293848814E9;
      
      private var var_795:int;
      
      private const const_1636:uint = 4.291613146E9;
      
      private var var_254:int = -1;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_219.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_796;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_796,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1434) : uint(const_1433);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_393,var_76,var_985);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_219.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_254) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_796);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_570[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_569[var_185]);
         _catalog.purchaseProductAsGift(var_393,var_76,var_985,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_52:
               ...
               break;
            case WindowKeyboardEvent.const_516:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_254 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_254 + 1);
                     break;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1434 = _loc1_.stuffTypes;
            var_570 = _loc1_.boxTypes;
            var_569 = _loc1_.ribbonTypes;
            var_796 = var_1434[0];
            _boxIndex = var_570[0];
            var_185 = var_569[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_219.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_254) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_254);
         }
         var_254 = param1;
         if(var_254 < 0)
         {
            var_254 = _loc2_.numListItems - 1;
         }
         if(var_254 >= _loc2_.numListItems)
         {
            var_254 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_254) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_219 == null)
         {
            var_219 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_472 == null)
         {
            var_472 = createWindow("suggestion_list_item") as IWindowContainer;
            var_472.procedure = suggestionsEventHandler;
         }
         if(var_219 == null || var_472 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_219.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_472.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
