package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_794:int = 0;
      
      public static const const_152:int = 5;
      
      private static const const_351:int = 1;
      
      private static const const_793:int = 2;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1599)
         {
            ...
            case RecyclerStatusMessageEvent.const_813:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1201:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1599 != RecyclerStatusMessageEvent.const_813;
      }
      
      private function get statusActive() : Boolean
      {
         return var_283 != const_794;
      }
      ...
      {
         return active && var_283 == const_351;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_970:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1197:
