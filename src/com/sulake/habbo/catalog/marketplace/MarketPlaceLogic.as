package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1666:int = 3;
      
      public const const_1520:int = 2;
      ...
      private var var_2257:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1624,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1885 || param1.furniTypeId != var_1882)
         {
            return;
         }
         var_2257 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_206.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1520,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_206.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_206.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_399)
            {
               var_206.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1752 = _loc3_.creditsWaiting;
         var_206 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_206.add(_loc4_.offerId,_loc6_);
         }
      ...
      {
         requestOffers(var_2256,var_2258,var_2035,var_2255);
      }
