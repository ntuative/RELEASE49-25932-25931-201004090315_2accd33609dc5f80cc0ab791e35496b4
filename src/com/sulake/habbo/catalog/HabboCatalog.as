package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_411:ClubBuyController;
      ...
      private var var_107:IMarketPlace;
      ...
      private var var_295:CatalogViewer;
      
      private var var_1887:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_410:ICatalogNavigator;
      
      private var var_589:IAvatarRenderManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_80:RecyclerLogic;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_1889:GiftWrappingConfiguration;
      ...
      {
         return var_347.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_108.credits = _loc3_.balance;
         updatePurse();
         if(!var_1888 && var_487 != null)
         {
            var_487.playSound(HabboSoundTypesEnum.const_1013);
         }
         var_1888 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_347.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_83)
         {
            _loc3_ = var_347.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_80 == null)
         {
            return;
         }
         var_80.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_411 == null)
         {
            var_411 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_93:
               var_1216 = param1.session.isPrivateRoom;
               if(var_80 != null)
               {
                  var_80.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_102:
               ...
               if(var_80 != null)
               {
                  var_80.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         var_80.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "AvatarImagePartContainer" == var_154.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_154.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1889 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
            _events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(var_80 != null && getCurrentLayoutCode() == "recycler")
            {
               var_80.activate();
            }
         }
      ...
      {
         var_80 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_410 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_108.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_108.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_108.isVIP = _loc2_.isVIP;
         updatePurse();
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         {
            var_411.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_107.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_107 == null)
         {
            var_107 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      {
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_410.buildCatalogIndex(_loc2_);
         if(var_1015 != "")
         {
            var_410.openPage(var_1015);
            var_1015 = "";
         }
         else
         {
            var_410.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_175)
         {
            _loc3_ = var_154.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_295 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_295.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_80.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_108.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_108.pixels));
         var _loc1_:int = 0;
         if(true)
         {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_108.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_108.clubPeriods));
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_295.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_108.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1887 && var_487 != null)
         {
            var_487.playSound(HabboSoundTypesEnum.const_894);
         }
         var_1887 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_295.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_295.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_295 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_295.habboCatalog = this;
      }
