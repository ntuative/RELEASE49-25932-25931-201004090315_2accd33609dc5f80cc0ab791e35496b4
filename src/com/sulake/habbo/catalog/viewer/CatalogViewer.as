package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1436:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_393 != null)
         {
            if(var_393.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_393.window);
            var_393.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1436);
         var_393 = _loc5_;
      ...
      {
         return var_393.dispatchWidgetEvent(param1);
      }
