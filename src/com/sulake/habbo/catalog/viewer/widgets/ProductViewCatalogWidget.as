package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1261:IScrollbarWindow;
      
      protected var var_1233:XML;
      
      private var var_1260:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1330.text = "${" + _loc3_.name + "}";
            var_1329.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1330.text = "${" + _loc2_.localizationId + "}";
            var_1329.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_474:
                  _loc4_ = var_1260.clone();
                  if(var_601 != null)
                  {
                     var_601.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_601,var_1261,var_1233);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_202:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_308,AvatarAction.const_638);
                              _loc13_.appendAction(AvatarAction.const_601,_loc6_.productClassId);
      ...
      {
         var_1330 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1329 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1514 = new Point(var_84.x,var_84.y);
         var_601 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1261 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_601 == null)
         {
         ...
         var_1260 = _loc2_.content as BitmapData;
