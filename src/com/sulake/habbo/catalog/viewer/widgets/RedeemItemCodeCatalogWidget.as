package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1009 != null)
         {
            var_1009.removeEventListener(WindowKeyboardEvent.const_145,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_1009 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1009 != null)
         {
            var_1009.addEventListener(WindowKeyboardEvent.const_145,windowKeyEventProcessor);
         }
      }
