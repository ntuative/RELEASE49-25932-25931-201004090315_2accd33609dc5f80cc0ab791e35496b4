package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_428 >= var_304.length)
         {
            return "";
         }
         var petColor:IPetColor = var_304[var_428] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_612[var_1528] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_428 = param1.index;
         if(var_428 < 0 || var_428 > var_304.length)
         {
            var_428 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         var_867 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_304 = [];
         var_612 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_867);
               if(_loc11_)
               {
                  var_612 = _loc11_.breeds;
                  var_304 = _loc11_.colors;
                  if(var_304 == null)
                  {
                     var_304 = [];
                  }
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_612.length)
         {
            _loc12_ = var_612[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_867,_loc12_.id),getRaceLocalizationKey(var_867,_loc12_.id)));
            _loc6_++;
         }
         var_603.add(var_867,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_962,onApproveNameResult);
      ...
      private function updateImage() : void
      {
         ...
         if(var_428 >= 0 && var_428 < var_304.length)
         {
            _loc7_ = var_304[var_428] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_612[var_1528] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_867,_loc3_.id,_loc2_,AvatarScaleType.const_53);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_308,AvatarAction.const_677);
