package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_887:MarketPlaceOfferData;
      
      private const const_1411:int = 1;
      
      private const const_1649:int = 40;
      
      private var var_518:IWindowContainer;
      
      private const const_1410:int = 2;
      ...
      private function updateList() : void
      {
         ...
         if(!var_518)
         {
            ...
            var_518 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_518)
         {
            return;
         ...
         updateStatusDisplay(const_1410,_loc2_.length);
         if(!var_439)
         {
            var_439 = new Timer(25);
            var_439.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_888 = 0;
         populateList();
         var_439.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_518 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_518.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1411);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_440.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_439)
         {
            var_439.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_439 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_888 >= var_603.length)
            {
               return true;
            }
            addListItem(var_603.getWithIndex(var_888));
            ++var_888;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_887.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_440));
            _loc7_.selection = 0;
         }
      }
