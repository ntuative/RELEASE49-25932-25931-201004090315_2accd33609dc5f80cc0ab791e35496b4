package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = var_599[var_1037][var_1985];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_375 || _loc1_.pricingModel == Offer.const_429)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_83 || _loc3_.productType == ProductTypeEnum.const_81)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1038.indexOf(_loc5_) == -1)
                        {
                           var_1038.push(_loc5_);
                           var_599.push(new Array());
                        }
                        _loc6_ = var_1038.indexOf(_loc5_);
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_599)
         {
            if(var_1985 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1985] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1037 = var_949.getGridItemIndex(param1.view);
