package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_46:ClubGiftController;
      ...
      private function updateList() : void
      {
         ...
         var_603.reset();
         _loc2_ = var_46.getOffers();
         if(!_loc2_)
         {
            return;
         }
         var _loc3_:Map = var_46.getGiftData();
         if(!_loc3_)
         {
            return;
         }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_197)
         {
            var_197 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_197)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_197.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_197.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
         var_197.visible = true;
         var_197.activate();
      }
      ...
      private function updateInfo() : void
      {
         ...
         if(false)
         {
            ...
            var_46.localization.registerParameter(_loc2_,"amount",var_46.giftsAvailable.toString());
         }
         else if(false)
         {
            _loc2_ = "catalog.club_gift.days_until_next";
            var_46.localization.registerParameter(_loc2_,"days",var_46.daysUntilNextGift.toString());
         }
         else if(false)
         {
         ...
         _loc1_.text = var_46.localization.getKey(_loc2_);
      }
      ...
      {
         if(!param1 || !param2 || !var_603 || !var_46)
         {
            return;
         }
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         var _loc6_:String = var_46.localization.getKey("catalog.club_gift.months_required");
