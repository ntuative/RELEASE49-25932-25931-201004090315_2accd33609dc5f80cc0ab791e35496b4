package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2358:String = "magic.pixels";
      
      private var var_2357:String = "catalog.page.club";
      
      private var var_2374:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","false") == "AvatarImagePartContainer";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2357,true);
      }
