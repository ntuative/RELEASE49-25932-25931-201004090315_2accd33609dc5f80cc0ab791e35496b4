package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1058:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1462:XML;
      
      private static var var_1463:XML;
      ...
      private var var_1461:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1463 == null)
         {
            ...
            var_1463 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1461 == 4294967295)
            {
               var_1461 = _loc1_.color;
            }
            _loc1_.color = const_1058;
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1462) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_47 = navigator.catalog.windowManager.buildFromXML(var_1463) as IItemListWindow;
         if(var_47 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1136;
            }
         }
      }
