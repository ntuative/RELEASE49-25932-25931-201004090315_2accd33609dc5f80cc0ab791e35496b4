package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1257 || var_1421 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1422 == 0 || _loc1_ - var_1422 > var_1421)
         {
            if(_connection != null)
            {
      ...
      {
         var_1257 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1421 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
