package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_777:uint = 11;
       
      
      private var var_234:LatencyTracker = null;
      ...
      private var var_146:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1069:int = -1;
      
      private var var_896:LagWarningLogger = null;
      
      private var var_895:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_234 = new LatencyTracker();
         var_896 = new LagWarningLogger();
         var_1314 = new Array(const_777);
         var _loc4_:int = 0;
         while(_loc4_ < const_777)
         {
            var_1314[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1265,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1225,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1320,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_628,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_943,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1398);
               break;
            case HabboCommunicationEvent.const_566:
               trackLoginStep(HabboLoginTrackingStep.const_1280,String(_communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_225:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_225);
               if(var_234 != null)
               {
                  var_234.init();
               }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_234 != null)
            {
               var_234.communication = _communication;
               var_234.connection = param1;
            }
            if(var_896 != null)
            {
               var_896.connection = param1;
            }
         }
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_285:
      ...
      {
         var_154 = IHabboConfigurationManager(param2);
         if(var_154)
         {
            Component(var_154).events.addEventListener(HabboConfigurationEvent.const_176,onConfigurationLoaded);
            if(var_234 != null)
            {
               var_234.configuration = var_154;
            }
            if(var_235 != null)
            {
               var_235.configuration = var_154;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_259.events.addEventListener(AdEvent.const_431,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2147)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1326);
            var_2147 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_943,String(_loc2_.guestRoomId));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_566,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_213,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_161,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_151,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_225,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_637,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_65,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_414,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_371:
               var_896.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_895)
            {
               var_895.release(new IIDHabboWindowManager());
               var_895 = null;
            }
            if(var_259)
            {
            ...
            if(var_176)
            {
               if(true)
               {
                  ...
                  Component(var_176).events.removeEventListener(HabboFriendListTrackingEvent.const_285,onFriendlistTrackingEvent);
               }
            ...
            if(var_146)
            {
               if(true)
               {
                  var_146.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_146.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_146.release(new IIDHabboHelp());
               var_146 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_371,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_154)
         {
            if(var_896 != null)
            {
               var_896.configure(var_154);
            }
            Component(var_154).events.removeEventListener(HabboConfigurationEvent.const_176,onConfigurationLoaded);
         }
      }
      ...
      {
         var_146 = param2 as IHabboHelp;
         var_146.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_146.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_1016);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_1016,onCoreRunning);
         }
      }
      ...
      {
         var_895 = IHabboWindowManager(param2);
         if(var_895)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1069 > -1 && _loc2_ < var_1069)
         {
            ++var_1557;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1557);
         }
         if(var_1069 > -1 && _loc2_ - var_1069 > 15000)
         {
            ++var_1558;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1558);
         }
         var_1069 = _loc2_;
         if(var_235 != null)
         {
      ...
      {
         if(var_154 != null && Boolean(var_154.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_371,onLagWarningEvent);
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_176).events.addEventListener(HabboFriendListTrackingEvent.const_285,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_154)
            {
               if(var_154.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_154.getKey("client.fatal.error.url");
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_637)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1313);
         }
         else if(param1.type == HabboHotelViewEvent.const_414)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1261);
         }
         else if(param1.type == HabboHotelViewEvent.const_65)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1156);
         }
      }
   }
}
