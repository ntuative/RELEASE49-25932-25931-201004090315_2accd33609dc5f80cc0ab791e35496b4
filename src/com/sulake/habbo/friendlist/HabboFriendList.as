package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1603:OpenedToWebPopup;
      
      private var var_823:IAvatarRenderManager;
      ...
      private var var_1604:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_632:ISessionDataManager;
      
      private var var_367:FriendRequests;
      
      private var var_1819:int;
      
      var var_85:FriendCategories;
      
      private var var_2267:FriendListLookAndFeel;
      ...
      {
         var_2267 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_85 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1604 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_448.findTab(FriendListTab.const_85).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_632 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         {
            var_85.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_85.addCategory(new FriendCategory(FriendCategory.const_875,getText("friendlist.friends")));
         var_85.addCategory(new FriendCategory(FriendCategory.const_417,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_85.addFriend(new Friend(_loc4_));
         }
         var_448 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_539)
         {
            var_539 = new Timer(120000);
            var_539.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_539.start();
         }
         getBuddyRequests();
         registerListeners();
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_539.stop();
            var_539.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_539 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_823)
         {
            var_823.release(new IIDAvatarRenderManager());
            var_823 = null;
         }
         if(var_931)
         {
            var_931.release(new IIDHabboNotifications());
            var_931 = null;
         }
         if(var_195)
         {
         ...
         if(var_632)
         {
            var_632.release(new IIDSessionDataManager());
            var_632 = null;
         }
         super.dispose();
      }
      ...
      {
         var_85.onFriendListUpdate(param1);
      ...
      {
         var _loc1_:String = var_154.getKey("client.minimail.embed.enabled");
         return _loc1_ == "AvatarImagePartContainer";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_448.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_285));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1604.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function canBeAskedForAFriend(param1:int) : Boolean
      {
         ...
         return this.getFriend(param1) == null && !searchResults.isFriendRequestSent(param1) && categories.method_3(false) < friendRequests.limit;
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_85.findFriend(param1);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_632.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_632.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
      ...
      {
         var _loc2_:FriendListTab = var_448.findTab(FriendListTab.const_85);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_823.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_448.findTab(FriendListTab.const_85);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_823 = param2 as IAvatarRenderManager;
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationReady);
      }
      
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_931 = param2 as IHabboNotifications;
         queueInterface(new IIDHabboWindowManager(),onWindowManagerReady);
      }
      
      public function method_3(param1:Boolean, param2:Boolean) : int
      {
         if(_view == null)
         {
         ...
         return this.var_85.method_3(param1,param2);
      }
      ...
      {
         return var_154.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1603 == null)
         {
            var_1603 = new OpenedToWebPopup(this);
         }
         var_1603.show(x,y);
      }
