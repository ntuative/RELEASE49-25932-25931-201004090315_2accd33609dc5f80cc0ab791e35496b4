package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_306:int = 100;
      ...
      {
         return Math.ceil(this.var_222.length / const_306);
      }
      ...
      {
         if(this.var_809 >= this.getPageCount())
         {
            this.var_809 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_809 + 1) * const_306,this.var_222.length);
      }
