package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_530:Point = null;
      
      private var var_765:Map = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_532 != null)
         {
            ...
            {
               _loc2_ = var_532.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_532.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_765.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_292:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_532.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_765.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_588,RoomWidgetChatSelectAvatarMessage.const_704];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_588:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_147,_container.roomSession,0,"Version 25932-25931-201004090240");
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_927 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_927);
            }
            if(var_530 == null)
            {
               var_531.x = 0;
               var_531.y = 0;
               var_531.z = 0;
               var_530 = _loc4_.getScreenPoint(var_531);
               var_927 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_531.x = 0;
            var_531.y = 0;
            var_531.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_531);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_530.x || _loc8_.y != var_530.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_530,_loc5_));
