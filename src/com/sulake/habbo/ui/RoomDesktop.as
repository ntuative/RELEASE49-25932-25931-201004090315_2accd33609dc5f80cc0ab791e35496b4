package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_818:IHabboHelp = null;
      ...
      private var var_589:IAvatarRenderManager = null;
      ...
      private var var_167:IToolTipWindow;
      
      private var var_347:ISessionDataManager = null;
      
      private var var_1952:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_438,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_707,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_701 = _roomEngine.loadRoomResources(var_35.roomResources);
            if(false)
            {
               var_1238 = false;
         ...
         {
            var_1239 = !var_259.showInterstitial();
         }
         method_5();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_35.roomId,var_35.roomCategory,var_264[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_438,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_707,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_17 = null;
         var_817 = null;
         ...
         if(var_195 && false)
         {
            ...
            var_195.events.removeEventListener(HabboToolbarEvent.const_57,onHabboToolbarEvent);
         }
         var_195 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1952);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_195 != null)
         {
            var_168.toolbarSize = var_195.size;
            var_168.toolbarOrientation = var_195.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_265:
               _loc3_ = "null";
               break;
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && var_167 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(0,15);
            var_167.setGlobalPosition(_loc8_);
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_706:
               ...
               if(var_685 != null && _loc3_ == RoomObjectCategoryEnum.const_36)
               {
                  _loc7_ = var_35.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_295)
                  {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_613);
            _loc13_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_538);
            _loc14_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_500);
            _loc15_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_641);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_265,canvasMouseHandler);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_477:
               ...
               var_167 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_299,WindowStyle.const_337,WindowParam.const_89) as IToolTipWindow;
               var_167.setParamFlag(WindowParam.const_48,false);
      ...
      {
         if(var_17 != null && var_35 != null && var_1239 && var_1238)
         {
            var_17.startSession(var_35);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_243));
         }
      }
