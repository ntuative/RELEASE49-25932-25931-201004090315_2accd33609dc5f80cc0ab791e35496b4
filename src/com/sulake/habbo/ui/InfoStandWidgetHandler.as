   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_134,onUserTags);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_134,onUserTags);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_518);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_294);
               ...
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_847);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_292)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_295)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_902)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_542);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_223)
               {
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1246;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1008;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1007;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1258);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_609.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_53);
            var_609.add(_loc2_.petId,_loc5_);
         }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_296);
         _loc1_.push(RoomWidgetUserActionMessage.const_634);
         _loc1_.push(RoomWidgetUserActionMessage.const_681);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_526);
         _loc1_.push(RoomWidgetFurniActionMessage.const_543);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_653);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1157);
         _loc1_.push(RoomWidgetPetCommandMessage.const_654);
         _loc1_.push(RoomWidgetPetCommandMessage.const_679);
      ...
      public function dispose() : void
      {
         ...
         if(var_609 != null)
         {
            _loc1_ = var_609.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_609.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_296:
            ...
            case RoomWidgetUserActionMessage.const_634:
               ...
               break;
            case RoomWidgetUserActionMessage.const_681:
            ...
            case RoomWidgetUserActionMessage.const_599:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_933,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_739:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_526:
            ...
            case RoomWidgetFurniActionMessage.const_267:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_543:
            ...
            case RoomWidgetUserActionMessage.const_469:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_653:
            ...
            case RoomWidgetUserActionMessage.const_612:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_679:
