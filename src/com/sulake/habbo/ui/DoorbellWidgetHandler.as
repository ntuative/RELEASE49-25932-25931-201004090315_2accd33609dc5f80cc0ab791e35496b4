package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_105:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_546,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_568];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_568:
      ...
      {
         return [RoomSessionDoorbellEvent.const_105,RoomSessionDoorbellEvent.const_128,RoomSessionDoorbellEvent.const_54];
      }
