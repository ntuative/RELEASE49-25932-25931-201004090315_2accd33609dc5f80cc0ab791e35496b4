   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            _loc6_ = _container.avatarRenderManager.createAvatarImage(_loc4_,AvatarScaleType.const_53,_loc5_);
            if(_loc6_ != null)
            {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_917,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_416,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_178,onCreditBalance);
         }
         var_10 = _container.inventory;
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_855,onAvatarEffectsChanged);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_800,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_416,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_103:
               ...
               break;
            case HabboHelpTutorialEvent.const_416:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_720);
         _loc1_.push(RoomWidgetDanceMessage.const_652);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_650);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_583);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_709);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_733);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_669);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_726);
         _loc1_.push(RoomWidgetStopEffectMessage.const_591);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1330);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_976);
         _loc1_.push(RoomWidgetToolbarMessage.const_648);
         _loc1_.push(RoomWidgetToolbarMessage.const_502);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_629);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1139);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_886);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_540);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_617);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_673);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1249);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_703);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_715);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_576);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_617:
               ...
               break;
            case RoomWidgetWaveMessage.const_720:
               if(_container != null && false)
               {
            ...
            case RoomWidgetDanceMessage.const_652:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_650:
               if(var_10 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_709:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_726:
               ...
               break;
            case RoomWidgetOpenInventoryMessage.const_669:
               ...
               if(var_10 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_982:
                        _catalog.openCatalogPage(CatalogPageName.const_1245,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_947:
                        var_10.toggleInventoryPage(InventoryCategory.const_238);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1315:
                        var_10.toggleInventoryPage(InventoryCategory.const_75);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1145:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_733:
            case RoomWidgetStopEffectMessage.const_591:
            ...
            case RoomWidgetNavigateToRoomMessage.const_976:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_540:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_648:
               ...
               if(var_195)
               {
                  var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_502:
               ...
               if(var_195 && false)
               {
                  var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_432,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_629:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_553));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_673:
