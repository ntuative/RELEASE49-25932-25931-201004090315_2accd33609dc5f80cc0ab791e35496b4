package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1019:PaletteManager;
      
      private var var_693:PetDataManager;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_77:
               _loc3_ = var_225.getValue(AvatarType.const_77) as AvatarStructure;
               break;
            case AvatarType.PET:
               _loc3_ = var_225.getValue(AvatarType.PET) as AvatarStructure;
               break;
            default:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_225.getValue(AvatarType.const_77) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_225.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      private function init() : void
      {
         ...
         var_693 = new PetDataManager(_loc1_,_loc3_);
         var_1019 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_693.populateFigureData(_loc4_);
         ...
         var_225.add(AvatarType.const_77,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_225.add(AvatarType.PET,_loc5_);
      }
      
      public function get petDataManager() : IPetDataManager
      {
         return var_693 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_730 = param1;
         if(var_730 == RenderMode.const_1348)
         {
            init();
         }
         if(var_730 == RenderMode.const_1224)
         {
            init();
      ...
      {
         var _loc5_:String = var_693.createAvatarFigureString(param1,param2,param3);
         var _loc6_:AvatarStructure = var_225.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_225.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:AvatarStructure = var_225.getValue(AvatarType.const_77) as AvatarStructure;
         if(_loc4_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc4_,_aliasCollection,param1,param2,AvatarType.const_77,param3);
      }
