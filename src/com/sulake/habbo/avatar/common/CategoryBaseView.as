package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseView
   {
      ...
      protected var var_157:Boolean;
      
      protected var var_140:String = "";
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_2270);
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_33[var_140];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function showPalettes(param1:String, param2:int) : void
      {
         ...
         var _loc3_:AvatarEditorGridView = var_33[param1] as AvatarEditorGridView;
         if(!_loc3_)
         {
            return;
         }
