package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1515:String = "hot_looks";
      
      public static const const_1582:String = "my_looks";
      ...
      public function HotLooksModel(param1:HabboAvatarEditor)
      {
         ...
         var_421["null"] = new Array();
         var_421["null"] = new Array();
         var_421["undefined.index"] = 0;
         var_421["undefined.index"] = 0;
         requestHotLooks();
      }
      ...
      {
         var _loc1_:String = var_46.configuration.getKey("avatareditor.promohabbos");
         var _loc2_:URLRequest = new URLRequest(_loc1_);
         var _loc3_:AssetLoaderStruct = var_46.assets.loadAssetFromFile("hotLooksConfiguration",_loc2_,"text/xml");
         _loc3_.addEventListener(AssetLoaderEvent.const_33,onHotLooksConfiguration);
      }
      
      public function selectHotLook(param1:int) : void
      {
         var _loc2_:Array = var_421["null"];
         ...
         if(_loc3_ != null)
         {
            ...
            var_46.loadAvatarInEditor(_loc3_.figure,_loc3_.gender,var_46.clubMemberLevel);
         }
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         var _loc3_:XmlAsset = var_46.assets.getAssetByName("hotLooksConfiguration") as XmlAsset;
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.content as XML;
            for each(_loc5_ in _loc4_.habbo)
            {
               _loc6_ = new Outfit(var_46,_loc5_.@figure,_loc5_.@gender);
               (var_421[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
