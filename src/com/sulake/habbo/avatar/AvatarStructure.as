package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_437:PartSetsData;
      
      private var var_2097:PartOffsetData;
      
      private var var_881:AvatarActionManager;
      
      private var var_174:IAssetLibrary;
      
      private var var_1061:IAssetLibrary;
      
      private var var_2098:AvatarRenderManager;
      ...
      private var var_1541:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_437 = new PartSetsData();
         _animationData = new AnimationData();
         var_1541 = new AvatarStructureDownloadSet();
         var_731 = new AnimationManager();
         var_732 = param4;
         var_2097 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_881.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_732)
         {
            case AvatarType.const_77:
               _loc1_ = var_174.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_437.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_174.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_174.getAssetByName("HabboAvatarFigure").content as XML;
               ...
               break;
            case AvatarType.PET:
               _loc1_ = var_174.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_437.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_174.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_174.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_308.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_881.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_308.appendXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_881.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_731.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_437.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_437.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1222[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_881.getDefaultActionType();
         var _loc9_:Array = var_437.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_731.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_437.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_437.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_77:
               if(var_174.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_174.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_174.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_174.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_732 + " ready to go!");
         if(var_732 == AvatarType.const_77)
         {
            var_437.getPartDefinition("ri").appendToFigure = true;
            var_437.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_77:
               if(var_174.hasAsset(_loc5_))
               {
                  var_174.removeAsset(var_174.getAssetByName(_loc5_));
               }
               var_1541.add(new AvatarStructureDownload(var_174,_loc5_,var_308));
               break;
            case AvatarType.PET:
         }
         var_1541.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_731.getAnimation(param1);
      }
      ...
      {
         var_881 = new AvatarActionManager(var_174,var_732);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1289 = var_308.getMandatorySetTypeIds();
         return var_1289;
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1061.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1061.getAssetByName("dance" + _loc1_).content as XML;
            var_731.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1061.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1061.getAssetByName("fx" + _loc1_).content as XML;
            var_731.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_881.sortActions(param1);
      }
   }
}
