   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_492:
                  ...
                  break;
               case const_491:
                  _model.controller.gender = FigureData.const_84;
                  param1.stopPropagation();
            }
         }
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(_model,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
