package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2113:uint;
      
      private var var_1587:uint;
      
      private var var_1590:Number = 1;
      
      private var var_2111:Boolean = true;
      
      private var var_1588:uint;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         var_1547 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_2112 = parseInt(_loc2_,16);
         var_2113 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1588 = _rgb >> 16 & 255;
         var_1587 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1590 = var_1588 / 255 * 1;
         var_1586 = var_1587 / 255 * 1;
         var_1589 = _b / 255 * 1;
         if(var_1547 == 37)
         {
         ...
         _colorTransform = new ColorTransform(var_1590,var_1586,var_1589,_alphaMultiplier);
         var_1063 = generatePaletteMapForGrayscale(var_2113,var_2112);
      }
      
      public function get reds() : Array
      {
         return var_1063.getValue("reds") as Array;
      }
      ...
      {
         return var_1063.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1063.getValue("greens") as Array;
      }
      ...
      {
         return var_1063.getValue("alphas") as Array;
      }
