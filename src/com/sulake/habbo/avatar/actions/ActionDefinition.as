package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1962 = parseInt(param1.@precedence);
         var_1958 = String(param1.@activepartset);
         var_1960 = String(param1.@assetpartdefinition);
         var_1956 = String(param1.@lay);
         var_1142 = String(param1.@geometrytype);
         var_1771 = Boolean(parseInt(param1.@main));
         var_1961 = Boolean(parseInt(param1.@const_1627));
         var_1957 = Boolean(parseInt(param1.@animation));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(var_629.getValue(param1) == null)
         {
            var_629.add(param1,new Map());
         }
         var _loc4_:Map = var_629.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_629.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1241.concat(getTypePrevents(param1));
      }
