package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2293:BitmapData;
      
      protected var var_952:Boolean;
      ...
      protected var var_377:BitmapData;
      
      private const const_1438:Number = 0.2;
      
      protected var var_1393:Boolean;
      
      private const const_1437:Number = 1;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1420));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1438;
               _loc1_.blend = const_1438;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(var_1393 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2293;
               _loc5_.visible = true;
            }
            else
            {
