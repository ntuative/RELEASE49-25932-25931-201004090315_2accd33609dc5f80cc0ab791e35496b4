package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_743:uint = 4284532064;
      
      private static const const_744:uint = 2577770;
      
      public static const const_927:int = 0;
      ...
      private var var_329:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_329 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_171)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_802)
            {
            ...
            var_329.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_400);
            var_329.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_161)
            {
               var_161.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_161.stop();
               var_161 = null;
            }
            if(var_329 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1404 == null)
         {
            var_1404 = createMinimizedWindow();
         }
         if(!var_1624)
         {
            return var_60;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_161 == null)
         {
            var_161 = new Timer(1000,3);
            var_161.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_161.reset();
         var_161.repeatCount = 3;
         var_161.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_60)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_743) : uint(const_744);
            }
