package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_872:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_17 != null)
         {
            var_17.events.removeEventListener(RoomSessionEvent.const_93,roomSessionEventHandler);
            var_17.events.removeEventListener(RoomSessionEvent.const_102,roomSessionEventHandler);
            var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_362,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_45.getValue(InventoryCategory.const_541));
      }
      ...
      {
         var_108.clubPeriods = param1;
         var_108.clubDays = param2;
         var_108.clubHasEverBeenMember = param3;
         var_108.isVIP = param4;
      ...
      {
         return PetsModel(var_45.getValue(InventoryCategory.const_138));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_855));
      }
      ...
      {
         return AchievementsModel(var_45.getValue(InventoryCategory.const_329));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_235:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_871.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_871.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_45.getValue(InventorySubCategory.const_235));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_347 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_871.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_108.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_45.getValue(InventoryCategory.const_325) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1054 = new IncomingMessages(this);
      ...
      {
         return var_108.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_108.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_45.getValue(InventoryCategory.const_238));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_17.events.addEventListener(RoomSessionEvent.const_93,roomSessionEventHandler);
         var_17.events.addEventListener(RoomSessionEvent.const_102,roomSessionEventHandler);
         var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_362,roomSessionEventHandler);
         ...
         var_45.add(InventoryCategory.const_325,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_347);
         var_45.add(InventoryCategory.const_238,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_45.add(InventoryCategory.const_541,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_347);
         var_45.add(InventoryCategory.const_329,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_45.add(InventorySubCategory.const_235,_loc8_);
         ...
         var_45.add(InventoryCategory.const_138,_loc10_);
