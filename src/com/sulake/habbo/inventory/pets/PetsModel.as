package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_138 && false)
         {
            var_46.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      ...
      {
         var_46.furniModel.switchCategory(param1);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1136 && param1.type == RoomEngineObjectEvent.const_218)
         {
            var_46.showView();
            var_1136 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(var_46.roomSession.isRoomOwner)
         {
            var_1136 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_36,RoomObjectTypeEnum.const_292,_loc3_.figure);
            var_46.closeView();
            return;
         }
         if(!var_46.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      {
         if(var_969.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
