package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_474 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_611.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_611.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_474.removeGridItem(_loc2_.window);
         if(var_303 == _loc2_)
         {
            var_303 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_611.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_474.addGridItem(_loc2_.window);
            var_611.add(param1.id,_loc2_);
            if(var_303 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_53);
            if(_loc13_ == null)
            {
               return;
            }
