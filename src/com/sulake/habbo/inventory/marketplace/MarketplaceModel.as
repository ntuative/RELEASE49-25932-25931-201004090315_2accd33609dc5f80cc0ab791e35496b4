package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1473,var_1472);
         }
      }
      ...
      {
         if(param1 != var_1885 || param2 != var_1882)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1886);
      }
      ...
      {
         if(var_46 != null && false && var_224 != null)
         {
            var_46.furniModel.removeLockFrom(var_224.id);
            var_224 = null;
         }
      }
      ...
      public function startOfferMaking(param1:IItem) : void
      {
         ...
         if(false)
         {
            var_46.furniModel.addLockTo(param1.id);
         }
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(_loc2_ == null)
         {
