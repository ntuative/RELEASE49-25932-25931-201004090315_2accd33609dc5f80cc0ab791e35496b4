package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_476 = new Timer(const_1056,1);
         var_476.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_46.getSubCategoryViewId() == InventorySubCategory.const_235;
      }
      ...
      public function method_2(param1:int, param2:String = null) : GroupItem
      {
         if(param2 == null)
         {
            param2 = "null";
      ...
      {
         return var_46.canUserOfferToTrade();
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_398.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_398.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_476 != null)
            {
               var_476.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_476.stop();
               var_476 = null;
            }
            if(var_125 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_171)
         {
         ...
         {
            var_991 = param1.ref;
            if(!var_46.recyclerModel.running)
            {
               requestClose();
            }
            var_807 = true;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_297)
         {
         ...
         if(var_678 == null)
         {
            var_678 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_678.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,_roomEngine,_loc9_.clone(),var_46.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      {
         var _loc1_:GroupItem = method_2(getSelectedItemIndex(),_view.visibleCategoryId);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         var _loc3_:TradingModel = var_46.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_235:
               ...
               break;
            case InventorySubCategory.const_805:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_46.checkCategoryInitilization(InventoryCategory.const_325);
      ...
      public function categorySwitch(param1:String) : void
      {
         if(param1 == InventoryCategory.const_75 && false)
         {
            ...
            {
               case const_42:
                  var_46.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_43:
                  var_46.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_304:
                  var_46.toggleInventoryPage(InventoryCategory.const_138);
            }
         }
      }
      ...
      public function requestSelectedFurniSelling() : void
      {
         ...
         var _loc3_:MarketplaceModel = var_46.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc2_:TradingModel = var_46.tradingModel;
         if(_loc2_ != null)
         {
            _loc1_ = _loc1_.concat(_loc2_.getOwnItemIdsInTrade());
         }
         var _loc3_:RecyclerModel = var_46.recyclerModel;
         if(_loc3_ != null)
         {
      ...
      {
         if(var_807 && param1.type == RoomEngineObjectEvent.const_218)
         {
            var_46.showView();
            var_807 = false;
         }
      ...
      {
         var _loc2_:GroupItem = method_2(getSelectedItemIndex(),_view.visibleCategoryId);
         if(_loc2_ == null)
         {
            return false;
         }
         ...
         if(_loc3_.category == FurniCategory.const_301 || _loc3_.category == FurniCategory.const_297 || _loc3_.category == FurniCategory.const_287)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_398.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_398 = new Map();
         var_398.add(const_42,new Array());
         var_398.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
