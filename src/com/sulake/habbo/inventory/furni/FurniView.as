package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_741:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_482 = new Map();
         var_482.add(FurniModel.const_42,new FurniGridView(_model,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         var_482.add(FurniModel.const_43,new FurniGridView(_model,FurniModel.const_43,_windowManager,_assetLibrary,_roomEngine));
      ...
      {
         var _loc3_:GroupItem = _model.method_2(_model.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_482.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_482.getValue(var_481);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = var_482.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.method_2(_loc3_,var_481);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_297)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_171)
               {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_741 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_482.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
