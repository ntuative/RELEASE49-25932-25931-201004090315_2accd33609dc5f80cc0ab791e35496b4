package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_925:BitmapData = null;
      ...
      private var var_924:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_431,0,0,_loc4_,var_1583,var_924,var_925));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2217 = int(_config.getKey("interstitial.interval","30000"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1357 = _loc2_.imageUrl;
         var_1583 = _loc2_.clickUrl;
         if(var_1357 != "" && var_1583 != "")
         {
            _loc3_ = var_1357;
            ...
            _loc4_ = new URLRequest(var_1357);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(var_1358 != "")
         {
            ...
            if(var_240 == null)
            {
               var_240 = new Timer(var_2216,1);
               var_240.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_240.reset();
            ...
            var_240.start();
            _loc4_ = new URLRequest(var_1358);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_473,0,0,param1.bitmapData,var_2215));
            var_763 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_925 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         var _loc1_:int = getTimer() - var_763;
         if(_loc1_ > var_2217)
         {
            ++var_1584;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_404));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_924 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
