package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_298.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(method_8));
      }
      
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         var _loc2_:* = null;
         if(_view != null && var_30)
         {
      ...
      private function method_8(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_127,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_917,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_149,onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_432,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_694,method_9);
         events.addEventListener(HabboToolbarShowMenuEvent.const_859,onHideWindowEvent);
         var_30 = true;
      ...
      private function method_9(param1:HabboToolbarShowMenuEvent) : void
      {
         if(var_30 && _view != null)
         {
