package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         {
            var_918 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_916.push(new XML());
               var_917.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_917[var_49] = param6.clone();
         }
      ...
      {
         if(var_1341 == true || var_757 == 0)
         {
            if(false)
            {
               ++var_49;
               if(var_49 >= var_916.length)
               {
                  var_49 = 0;
                  ++var_757;
               }
      ...
      {
         return var_916.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1341 == false && var_757 == 1 && var_1165 != var_30;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_918 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_918.width),Math.max(param2.height,var_918.height));
            _loc3_.copyPixels(var_918,var_918.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_49 <= var_917.length)
         {
            _loc2_ = var_917[var_49];
