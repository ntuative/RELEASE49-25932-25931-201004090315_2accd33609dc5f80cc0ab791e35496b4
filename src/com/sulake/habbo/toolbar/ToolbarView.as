package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_193 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_59,HabboWindowStyle.const_830,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1023 = String(_loc7_.relocate_by_drag.@state) == "AvatarImagePartContainer";
         if(var_1023)
         {
         ...
         var_1479 = _loc7_.toolbar.@min_group_margin;
         var_1480 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_262,param1,param2,_window,var_270);
         createGroupsFromXmlList(_loc9_,var_593,param1,param2,var_193,var_270);
         alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_262.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_593.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_129,var_495,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1479,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1225) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1479,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1225) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_593.length)
         {
            _loc3_ = var_593[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_129,var_495);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_593.length)
         {
            _loc2_ = var_593[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_495);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_129,var_495);
         }
      }
