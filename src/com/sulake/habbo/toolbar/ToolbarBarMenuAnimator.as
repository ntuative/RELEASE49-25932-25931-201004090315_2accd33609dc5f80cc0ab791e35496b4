package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1045:Number = 90;
      
      private static const const_768:int = 50;
      
      private static const const_1044:Number = 25;
      
      private static const const_1090:int = 50;
      ...
      private var var_1047:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1047 = param2;
         var_608 = new Timer(const_1044);
         var_608.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_507.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_507.splice(_loc3_,1);
            var_506.splice(_loc3_,1);
         }
         var_506.push(param1.name);
         var_507.push(param2);
         param1.addEventListener(WindowEvent.const_381,windowEventListener);
         param1.addEventListener(WindowEvent.const_215,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_507[var_506.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1047.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1047.getIconLoc(param1.iconId);
      ...
      {
         return var_506[var_507.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_607[_loc3_] = new Array();
            }
            if(var_607[_loc3_].indexOf(param1) < 0)
            {
               var_607[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_768 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_768 || param1.desktop.height - param1.y < const_1090;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_506[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_607[_loc3_].length)
                  {
                     repositionWindow(var_607[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
