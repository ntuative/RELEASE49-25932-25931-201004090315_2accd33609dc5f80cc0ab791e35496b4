package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_759:String = "tile_cursor";
      ...
      private static const const_1066:String = const_345;
      ...
      public static const const_571:String = "RCL_LOADER_READY";
      ...
      private var var_1013:IEventDispatcher = null;
      
      private var var_1215:Map = null;
      ...
      private var var_166:PublicRoomData = null;
      
      public function RoomContentLoader()
      {
         var_486 = [];
         var_484 = [];
         var_1861 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1863 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_407 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_305,_loc4_);
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_408 != null)
         {
            _loc2_ = var_408.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         if(var_166 != null && var_166.hasWorldType(const_276 + param1))
         {
            return var_166.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_484.indexOf(_loc14_) < 0)
                              {
                                 var_484.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_345 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_345.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_585.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_345,const_490,ROOM_CONTENT,const_759,const_760];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1861.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_153 && _loc5_ != RoomObjectLogicEnum.const_132)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_485.getValue(param1) as String;
      ...
      public function getPlaceHolderType(param1:String) : String
      {
         ...
         if(var_484.indexOf(param1) >= 0)
         {
            return const_490;
         }
         if(var_166 != null && (var_166.type == param1 || var_166.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1066;
      ...
      {
         if(var_584.getValue(param1) != null)
         {
            return var_584.getValue(param1);
         }
         return "";
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_409 != null)
         {
            _loc2_ = var_409.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1384);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1863.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1215.add(_loc5_,_loc8_);
               var_166 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_305,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_438,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_1865)
         {
            ...
            if(var_1013 != null)
            {
               var_1013.dispatchEvent(new Event(const_571));
            }
         }
      }
      ...
      public function method_11(param1:String) : Number
      {
         if(var_166 != null)
         {
            return var_166.getWorldHeightScale(const_276 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1864 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1860 = param2.getKey("public.room.dynamic.download.url","");
            var_1862 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_30 = const_761;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_345.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_409 != null)
         {
            var_409.remove(param1);
            var_409.add(param1,param2);
         }
         if(var_408 != null)
         {
            var_408.remove(param2);
            var_408.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_153 && _loc5_ != RoomObjectVisualizationEnum.const_132)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_276 + param1) == RoomObjectCategoryEnum.const_64)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1215.getValue(param1) != null)
         {
            var_166 = var_1215.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_457,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_166 != null)
         {
            return var_166.getWorldScale(const_276 + param1);
         }
         return 32;
      }
