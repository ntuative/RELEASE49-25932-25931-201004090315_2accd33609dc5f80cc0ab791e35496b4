package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1405:Number = Math.sqrt(0.5);
      ...
      protected var var_1429:String = null;
      ...
      protected var var_2280:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_616[param1] = _loc3_;
            var_617[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1429 != null && var_1429.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
      ...
      {
         var _loc3_:int = 0;
         if(var_2094 != param1 || var_2096 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_616[_loc3_] = "";
               var_617[_loc3_] = false;
               _loc3_--;
            }
            var_2094 = param1;
            var_2096 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2095 != param1 || var_2093 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2289 = _loc3_.getNumber(RoomObjectVariableEnum.const_197);
            ...
            var_1429 = _loc3_.getString(RoomObjectVariableEnum.const_280);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_286 != _loc3_.getUpdateID() || param1 != var_209 || param2 != var_2280)
         {
