package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_22:BitmapData = null;
         ...
         if(var_500 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  if(var_22 != null)
                  {
                     if(var_22.width != _loc2_.width || var_22.height != _loc2_.height)
                     {
                        var_22.dispose();
                        var_22 = null;
                     }
                     ...
                     {
                        var_22.copyPixels(_loc2_,_loc2_.rect,new Point(0,0));
                     }
                  }
                  if(var_22 == null)
                  {
                  ...
                  _loc3_ = Math.min(var_1030,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_1030,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_1030,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = _extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = var_708[_loc6_ % 0] as IGraphicAsset;
