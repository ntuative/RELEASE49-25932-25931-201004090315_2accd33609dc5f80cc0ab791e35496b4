package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_966:Point = null;
      
      private var var_459:Array;
      
      private var var_964:LayoutRasterizerData = null;
      ...
      private var var_460:Boolean = true;
      
      private var _adBgIndex:int = -1;
      
      private var var_886:IGraphicAssetCollection;
      ...
      {
         var_460 = true;
         var _loc3_:int = var_331.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_331.push(param1);
            var_461.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_965 = param1;
         var _loc3_:LayoutRasterizerData = var_37.getValue(var_646);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1134 = RoomObjectVariableEnum.const_853;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1134 = RoomObjectVariableEnum.const_834;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_965 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_965 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function initialize(param1:XML) : void
      {
         ...
         var_37.add(_loc2_,_loc3_);
         var_1644 = new Vector3d(-0.5,0.5,0);
         var_460 = false;
      }
      
      public function method_12(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         if(param2 == var_1646 && param3 == var_1645)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_965 + _adBgIndex);
            _loc5_ = param1.getSprite(var_965 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1134);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_403;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1644);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_37.length)
            {
               _loc2_ = var_37.getWithIndex(_loc1_) as LayoutRasterizerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_646)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_964 = var_37.getValue(var_646);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_37.getValue(var_646);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_964.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = var_886.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_966.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_966.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_331.indexOf(_loc10_) >= 0 && var_460)
            {
               param1 = var_331.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_886.getAsset(var_461[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               var_331.splice(param1,1);
               var_461.splice(param1,1);
