package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1554:int = 16777216;
      
      public static const const_1452:int = 1;
       
      
      private var var_2353:int = 69069;
      
      private var var_1151:int = 1;
      
      private var var_2354:int = 5;
      
      private var var_1419:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1419 * param2);
      }
      ...
      {
         var _loc1_:int = var_2353 * var_1151 + var_2354;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
