package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      private function renderRepeatLast(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = renderCells(var_26,_loc3_,true,param1);
         _loc2_ = var_26["-1"] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
            while(_loc3_ < var_22.height)
            {
      ...
      private function renderRepeatCenter(param1:IVector3d) : void
      {
         ...
         while(_loc9_ < 0)
         {
            _loc2_ = var_26[_loc9_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
         ...
         var _loc11_:int = 0;
         var _loc12_:int = 0;
         if(_loc6_ + _loc7_ > var_22.height)
         {
         ...
         if(_loc10_ == 0)
         {
            _loc2_ = var_26[0] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
               _loc8_ = _loc2_.getHeight(param1);
               if(_loc8_ > 0)
      ...
      private function renderRepeatAll(param1:IVector3d) : void
      {
         ...
         var _loc2_:int = getCellsHeight(var_26,param1);
         var _loc3_:int = 0;
         if(_loc2_ > var_22.height)
         {
         }
         while(_loc3_ < var_22.height)
         {
      ...
      {
         var _loc3_:int = 0;
         if(_repeatMode == const_584)
         {
            _loc3_ = getCellsHeight(var_26,param2);
            param1 = _loc3_;
         }
         if(isStatic)
         {
            if(var_22 != null)
            {
               if(var_22.height == param1 && Vector3d.isEqual(var_554,param2))
               {
                  return var_22;
               }
               var_22.dispose();
         ...
         if(var_22 == null)
         {
            var_22 = new BitmapData(_width,param1,true,16777215);
         }
      ...
      {
         if(param1 == null || param1.length == 0 || var_22 == null)
         {
            return param2;
         }
         var _loc5_:* = null;
         ...
         while(_loc7_ < param1.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  var_22.copyPixels(_loc6_,_loc6_.rect,new Point(0,param2),_loc6_,null,true);
                  if(param3)
                  {
                     param2 += _loc6_.height;
                  }
                  if(param3 && param2 >= var_22.height || !param3 && param2 <= 0)
                  {
                     return param2;
                  }
               }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_26.length)
            {
               _loc2_ = var_26[_loc1_] as PlaneMaterialCell;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function renderRepeatFirst(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = renderCells(var_26,_loc3_,false,param1);
         _loc2_ = var_26[0] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
      ...
      private function renderRepeatNone(param1:IVector3d) : void
      {
         ...
         renderCells(var_26,0,true,param1);
      }
      ...
      private function renderRepeatBorders(param1:IVector3d) : void
      {
         ...
         while(_loc7_ < -1)
         {
            _loc2_ = var_26[_loc7_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
