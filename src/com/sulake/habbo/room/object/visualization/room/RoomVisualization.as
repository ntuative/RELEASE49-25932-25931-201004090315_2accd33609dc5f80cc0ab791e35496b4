package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1154:int = 13421772;
      
      private static const const_766:int = 16777215;
      
      public static const const_1161:int = 10066329;
      
      private static const const_764:int = 13421772;
      
      public static const const_1148:int = 16777215;
      
      private static const const_1426:int = 0;
      
      public static const const_1290:int = 16777215;
      
      private static const const_765:int = 10066329;
      
      private static const const_767:int = 10066329;
      
      public static const const_1279:int = 13421772;
      ...
      private var var_587:Rectangle = null;
      ...
      private const const_1639:int = 250;
      ...
      private var var_413:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_413 = new RoomPlaneBitmapMaskParser();
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         while(_loc2_ < var_75.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_269)
            {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_910);
         var _loc7_:int = 0;
         while(_loc7_ < var_75.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_212,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_269)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1220)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_212,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_212 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_587 == null)
         {
            var_587 = super.boundingRectangle;
         }
         return new Rectangle(var_587.x,var_587.y,var_587.width,var_587.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_413.maskCount)
         {
            _loc6_ = var_413.getMaskType(_loc5_);
            _loc7_ = var_413.getMaskLocation(_loc5_);
            _loc8_ = var_413.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_101.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_212 || _loc3_.type == RoomPlane.const_180 && _loc8_ == RoomPlaneBitmapMaskData.const_201)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1469;
                        if(var_75.getPlaneType(_loc9_) == RoomPlaneData.const_144)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1154)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_979 || _loc9_.y != var_1715 || _loc9_.z != var_1718 || param1.scale != var_1716))
            {
               var_979 = _loc9_.x;
               var_1715 = _loc9_.y;
               var_1718 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_938);
            if(_loc10_ != var_1903)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_724));
            if(_loc11_ != var_1016)
            {
               var_1016 = _loc11_;
               var_1907 = var_1016 & 255;
               var_1906 = var_1016 >> 8 & 255;
               var_1905 = var_1016 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1807 + const_1639 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1807 = _loc7_;
         if(var_160 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_582);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_534);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_558);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1904 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_985));
            var_160 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_412.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_412[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_180)
            {
               if(var_1904)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1907 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1906 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1905 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_101.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_212 && param2 != null)
               {
                  _loc5_.id = param2;
               }
