package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_753:AvatarVisualizationData = null;
      ...
      {
         var_753 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc9_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_639);
         var _loc10_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_551);
         ...
         var _loc13_:int = param2 - var_1336;
         if(_loc13_ > 5000 && _loc6_ != null && _loc6_.getScale() == AvatarScaleType.const_53)
         {
         ...
         var _loc15_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_327);
         if(_loc15_ > 0)
         {
         ...
         var _loc16_:Boolean = var_286 != _loc3_.getUpdateID() || var_209 != param1.scale || var_160 != _loc4_.getUpdateID();
         var _loc17_:Boolean = var_446 || var_524 > 0;
         if(_loc16_ || _loc17_)
         {
            increaseUpdateId();
            --var_524;
            ...
            if(_loc6_ == null)
            {
               _loc42_ = _loc4_.getString(RoomObjectVariableEnum.const_820);
               _loc6_ = var_753.getAvatar(_loc7_,param1.scale,_loc42_);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc21_ = _loc4_.getNumber(RoomObjectVariableEnum.const_283);
            if(isNaN(_loc21_) || _loc4_.getString(RoomObjectVariableEnum.const_248) == "float")
            {
               _loc21_ = _loc20_;
            }
            else
            ...
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_248);
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_523);
            _loc6_.appendAction(AvatarAction.const_656,_loc22_,_loc23_);
            _loc24_ = false;
            if(_loc22_ == "lay")
            {
               _loc43_ = int(_loc23_);
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_424);
            if(_loc25_ > 0 && _loc6_.getScale() == AvatarScaleType.const_53)
            {
               _loc44_ = _loc4_.getNumber(RoomObjectVariableEnum.const_402);
               _loc45_ = 3;
               _loc46_ = param2 - _loc44_;
               if(_loc46_ < _loc45_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_308,AvatarAction.const_1229[_loc25_]);
               }
            }
            _loc26_ = _loc4_.getNumber(RoomObjectVariableEnum.const_914);
            if(_loc26_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_868,_loc26_);
            }
            _loc27_ = _loc4_.getNumber(RoomObjectVariableEnum.const_926);
            if(_loc27_ > 0)
            {
               _loc47_ = _loc4_.getNumber(RoomObjectVariableEnum.const_858);
               _loc48_ = 5;
               _loc49_ = param2 - _loc47_;
               if(_loc49_ < _loc48_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_951,_loc27_);
               }
            }
            _loc28_ = _loc4_.getNumber(RoomObjectVariableEnum.const_542);
            _loc29_ = 0;
            if(_loc28_ > 0)
            {
               _loc50_ = _loc4_.getNumber(RoomObjectVariableEnum.const_515);
               _loc51_ = 100;
               _loc52_ = param2 - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_946,_loc28_);
                  _loc53_ = 1;
                  while(_loc53_ < 10)
                  {
            ...
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_939);
            if(_loc29_ > 0)
            {
               _loc30_ = _loc29_;
            }
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_944,_loc30_);
            }
            if(_loc8_)
            {
               _loc6_.appendAction(AvatarAction.const_461);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_443) > 0;
            if(_loc31_ || _loc12_)
            {
            ...
            if(_loc14_)
            {
               _loc6_.appendAction(AvatarAction.const_353);
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_897);
            if(_loc32_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_601,_loc32_);
            }
            ...
            var_525 = null;
            _loc35_ = getSprite(const_1630);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_920))
            {
               _loc35_.visible = true;
               switch(param1.scale)
               {
                  case 32:
                     var_525 = var_753.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
                     _loc67_ = 3;
                     _loc68_ = -42;
                     break;
                  case 64:
                     var_525 = var_753.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
                     _loc67_ = 14;
                     _loc68_ = -83;
               }
               if(var_525 != null)
            ...
            var_773.push(getTimer() - _loc19_);
            if(false)
            {
               _loc69_ = 0;
               _loc70_ = "[";
               for each(_loc71_ in var_773)
               {
                  _loc69_ += _loc71_;
                  _loc70_ += "," + _loc71_;
               }
