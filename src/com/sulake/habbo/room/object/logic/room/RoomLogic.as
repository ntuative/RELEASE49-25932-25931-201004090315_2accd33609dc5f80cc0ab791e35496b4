package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1562:int = 1500;
      
      private var var_1561:int = 255;
      
      private var var_1560:int = 255;
      
      private var var_1317:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_674:
                  _loc2_.setString(RoomObjectVariableEnum.const_534,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_598:
                  _loc2_.setString(RoomObjectVariableEnum.const_582,_loc3_.value);
                  break;
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_363:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_201)
                  {
                     _loc8_ = "null";
                  }
                  var_413.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_581:
                  _loc7_ = var_413.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_413.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_938,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_985,int(_loc5_.bgOnly));
            var_1317 = _color;
            var_1561 = var_1149;
            var_1072 = _loc11_;
            var_1560 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_724,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1209,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1203,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1267,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_144)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_148 || _loc13_ == RoomPlaneData.const_269)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_898)
         {
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_724,_loc3_);
         }
      }
   }
}
