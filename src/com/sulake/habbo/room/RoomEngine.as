package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_496:String = "temporary_room";
      ...
      private static const const_1124:String = "tile_cursor";
      ...
      private var var_628:NumberBank;
      ...
      private var var_762:RoomMessageHandler = null;
      
      private var var_761:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_316 = new Map();
         var_628 = new NumberBank(1000);
         var_1083 = new Map();
         var_317 = new Map();
         var_64 = new RoomObjectEventHandler(this);
         var_762 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_64 != null)
         {
            ...
            {
               return var_64.deleteWallItem(var_114,var_113,param1);
            }
         }
         return false;
      }
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           ...
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_500) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_538) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_641) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_64 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_29)
            {
               return var_64.modifyWallItemData(var_114,var_113,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_761 != null)
         {
            var_761.release(new IIDRoomRendererFactory());
            var_761 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_761.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1015;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_636);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_620);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_622);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_808);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1020);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_923) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_967);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_363,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_581,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_528,var_114,var_113,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_64 != null)
         {
            return var_64.modifyRoomObject(var_114,var_113,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_674,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_598,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_39 != null)
         {
            ...
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.const_64);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_64 != null)
         {
            var_64.handleRoomObjectEvent(param1,var_114,var_113);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_197,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_294,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_280,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_814,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_990,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_847,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_251,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_602,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_25 == null || var_417 == null || var_39 == null || var_761 == null || _communication == null || _habboConfiguration == null || !var_2212)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_278,RoomObjectCategoryEnum.const_64);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1213,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_39.getRoom(getRoomIdentifier(var_114,var_113));
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1356);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1356);
         if(_loc1_ != null)
         {
      ...
      private function initializeObjectEvents() : void
      {
         if(var_25 != null)
         {
            if(false)
            {
               var_25.events.addEventListener(RoomObjectMouseEvent.const_199,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_446,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_254,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_699,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_113,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_110,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_121,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_130,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_106,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_111,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_95,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_470,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_394,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_401,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_388,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_383,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_411,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_359,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_372,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_67,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_355,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_398,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_236,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_458,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_291,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_319,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_379,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_846,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_445,roomObjectEventHandler);
               var_25.events.addEventListener(AvatarWalkWarpingWarningEvent.const_371,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(var_64 != null)
         {
            return var_64.initializeRoomObjectInsert(var_114,var_113,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_529 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_556,0,0));
            _loc2_ = 0;
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_251,param1,param2,param3,RoomObjectCategoryEnum.const_36));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_29:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_396);
                     break;
                  case RoomObjectCategoryEnum.const_36:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_150);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_283);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_571)
         {
            var_2212 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_197,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_294,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_280,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1015,1,true);
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_259.events.addEventListener(AdEvent.const_431,showRoomAd);
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_626,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_761 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_529 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_39.getRoom(const_496);
         if(_loc10_ == null)
         {
            _loc10_ = var_39.createRoom(const_496,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_628.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_31:
            case RoomObjectCategoryEnum.const_29:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_197,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_396,param8);
               break;
            case RoomObjectCategoryEnum.const_36:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_150,param2);
               break;
            case RoomObjectCategoryEnum.const_64:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_144,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_269,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_534,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_582,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_558,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_363,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         if(!isRoomObjectContentAvailable(param1) && param5 != null)
         {
            ...
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_997,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_628.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,param1);
         if(_loc9_ != null)
         {
            var_1356 = param1;
            var_1580 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1580 - _loc12_.width / 2;
            ...
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_422,var_114,var_113,-1,RoomObjectCategoryEnum.const_224));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_64 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_278,const_495);
                  var_64.handleRoomObjectEvent(_loc14_,var_114,var_113);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_114,var_113,param1,param2,new Vector3d(),1,null);
         }
         else if(var_11 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1356);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1580 - _loc6_.data.width / 2;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_320,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_853,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_834,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_825,RoomObjectVariableEnum.const_320,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_571,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_64 != null)
         {
            var_64.cancelRoomObjectInsert(var_114,var_113);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_39.getRoom(const_496);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_997);
      ...
      {
         return getRoomObjectBoundingRectangle(var_114,var_113,const_278,RoomObjectCategoryEnum.const_64,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_907,param6,true);
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_887,_loc13_,true);
            if(var_11 != null)
            {
               _loc10_ = Number(var_11.method_11(param6));
            }
         }
         else
         {
            _loc9_ = _loc7_.createRoomObject(const_278,const_495,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_618,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_636,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_538,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_500,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_641,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_910,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_674,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_598,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_363,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_201);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_620,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_622,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_620,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_622,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_808,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1020,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_788,const_1124,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_787,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
