package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1782:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25932-25931-201004090240");
         var_195 = param5;
         var_97 = new Map();
         var_97.add(HabboHelpViewEnum.const_1216,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_135,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_475,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_274,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_196,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_615,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_286,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_642,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_226,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_97.add(HabboHelpViewEnum.const_806,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_97.add(HabboHelpViewEnum.const_614,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_257 == HabboHelpViewEnum.const_135 || false)
         {
            return;
         }
         if(var_397 == null)
         {
            ...
            var_397 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_397 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_397 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_397 as IWindow);
      ...
      {
         return var_97.getValue(var_257);
      }
      ...
      {
         var_1781 = param1;
         var _loc2_:IHelpViewController = var_97.getValue(HabboHelpViewEnum.const_135) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_851:
               showUI(HabboHelpViewEnum.const_806);
               break;
            case CallForHelpResultEnum.const_829:
      ...
      {
         var _loc3_:* = null;
         if(var_257 == HabboHelpViewEnum.const_135)
         {
            return;
         }
         if(true)
         {
            ...
            var_574.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_574.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_397.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_574[1],var_574[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_574[0],var_574[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1447;
         _window.width = _loc1_.width + var_1448;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_195 != null)
            {
               var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_21.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_718));
      }
