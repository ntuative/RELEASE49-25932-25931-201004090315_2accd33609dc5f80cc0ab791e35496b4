package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_9:String = "client.init.volter.retry";
      ...
      public static const const_14:int = 9;
      ...
      public static const const_19:String = "client.init.volter.loaded";
      
      private static const const_23:String = "testLocalConnection";
      
      public static const const_8:String = "error_data";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            if(param3 != null)
            {
               _loc6_[const_8] = String(param3.getStackTrace());
            }
      ...
      private function onPreLoadingCompleted(param1:Event) : void
      {
         ...
         catch(error:Error)
         {
            ...
            reportCrash("Failed to finalize main swf preloading: " + error.message,const_14,error);
         }
      }
